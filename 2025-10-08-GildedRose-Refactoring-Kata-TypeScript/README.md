# Gilded Rose Refactoring Kata - TypeScript (Deno)

This is a Deno TypeScript implementation of the Gilded Rose Refactoring Kata. It began its life as a partial clone of [Emily Bache's Gilded Rose repo](https://github.com/emilybache/GildedRose-Refactoring-Kata), including only the TypeScript files, the Requirements files, and this README. Enjoy!

## Getting Started

### Prerequisites

You'll need to install [Deno](https://deno.com/), a modern TypeScript/JavaScript runtime.
...
For more installation options, visit [https://docs.deno.com/runtime/](https://docs.deno.com/runtime/).
...
That's it! Deno will automatically download dependencies and run the tests.
